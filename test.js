...
const lispParensChecker = require('./index');
let parenthesesValidator = lispParensChecker.areParenthesesNestedProperly;
...
describe('Code with open parentheses in a comment', () => {
    it('should return false when an open parenthesis is outside of a comment and a closed parenthesis is inside', () => {
        assert.equal(parenthesesValidator('( ; (code with open parentheses in a comment ()'), false);
    });
});
